...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.msgBox = $('<div class="msgBox"><div class="content"></div><a href="#" class="nin-usead">X</a></div>');
    this.elmStepContainer = $('<div></div>').addClass("stepContainer");
//    this.clearContainer = $('<div style="clear:both"></div>');
...
//        $this.target.append($this.clearContainer);
