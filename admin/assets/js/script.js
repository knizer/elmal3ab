...
////            $('#menu-toogle .sub-menu ul li a').click(function()
////        {
////            $('#menu-toogle .sub-menu').css("background", "red");
////        });
...
//	});
    ...
    $('.single-menu').click(function () {
        $('.sub-menu').hide();
        $('.single-menu h2').removeClass('active').next().slideUp('fast');
        $(this).find('h2:first').addClass('active').next().slideDown('fast');
//        $('#menu-toogle #cli-dr2 h2').removeClass('active').next().slideUp('fast');
//        $("this .sub-menu").addClass("jgudkdlkdldld");
//        $('#menu-toogle #cli-dr1 h2:first').addClass('active').next().slideDown('fast');
//             $('#menu-toogle #cli-dr2 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr3 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr4 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr5 h2').removeClass('active').next().slideUp('fast');
    });
//        $('#menu-toogle #cli-dr2').click(function() {
//             $('#menu-toogle #cli-dr2 h2:first').addClass('active').next().slideDown('fast');
//             $('#menu-toogle #cli-dr1 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr3 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr4 h2').removeClass('active').next().slideUp('fast');
//             $('#menu-toogle #cli-dr5 h2').removeClass('active').next().slideUp('fast');
//        });
