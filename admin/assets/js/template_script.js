...
//    $('#menu-toogle #cli-dr1').click(function () {
//        $('#menu-toogle #cli-dr1 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr2').click(function () {
//        $('#menu-toogle #cli-dr2 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr3').click(function () {
//        $('#menu-toogle #cli-dr3 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr4').click(function () {
//        $('#menu-toogle #cli-dr4 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr5').click(function () {
//        $('#menu-toogle #cli-dr5 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr6').click(function () {
//        $('#menu-toogle #cli-dr6 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr7').click(function () {
//        $('#menu-toogle #cli-dr7 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr8').click(function () {
//        $('#menu-toogle #cli-dr8 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr9').click(function () {
//        $('#menu-toogle #cli-dr9 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle #cli-dr10').click(function () {
//        $('#menu-toogle #cli-dr10 h2:first').addClass('active').next().slideDown('fast');
//    });
//    $('#menu-toogle .sub-menu ul li a').click(function (ev) {
//        $(this).find('.sub-menu').slideToggle();
//        ev.stopPropagation();
//    });
//
//    var url = window.location.href;
//    var $current = $('.sub-menu ul li a[href="' + url + '"]');
