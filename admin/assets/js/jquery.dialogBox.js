 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
 				...
 				if(!hasClose){
					dialogHTML[0] = '<section id="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><span class="dialog-box-close">×</span></div><div><h3 class="dialog-box-content"></h3></div>';
 				}else{					
 					dialogHTML[0] = '<section id="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><span class="dialog-box-close">×</span></div><div><h3 class="dialog-box-content"></h3></div>';
 				}
 			}
