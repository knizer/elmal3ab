            ...
            <div class="col-md-12">
                <div style="position: relative; width: 100%;">
                    <a class="tabs-area" id="bottom-zero">
                        <i class="icon-ty"><?php echo $count; ?></i>غير منشور
                    </a>
                    <a class="tabs-area" href="<?= ROOT; ?>videos/published">
                        منشور
                    </a>
                </div>
...
$("#search_by").submit(function(event) {
	...
	window.location.href = "<?php echo ROOT ?>videos/unpublished/"+$('.serch_txt').val()+"/<?php echo (int) $this->uri->segment(4) ?>";
});
</script>
</body>
</html>
