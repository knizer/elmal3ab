					...
					<div class="streaming-table">
						...
						<table id="stream_table" class='table table-striped table-bordered'>
							...
							<tbody class="tbody_admin">
								...
								<tr>
									<td><?= $group["id"]; ?></td>
									<td class="tables-centered-both-td"><?= $group["name"]; ?></td>
									<td class="tables-centered-both-td">
										<a onclick="viewInModal('groups/view/<?= $group['id']; ?>');" href="javascript:void(null);">
									...
									<td class="tables-centered-both-td">
										<?php if ($this->session->userdata("delete_group") == 1): ?> 
											<a onclick="alertDelete('groups/delete/<?= $group['id']; ?>', 'هل أنت متأكد من حذف هذة المجموعة؟');" href="javascript:void(null);">
