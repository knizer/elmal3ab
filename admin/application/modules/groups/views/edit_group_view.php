								...
								<div style="padding: 10px; margin-bottom: 40px;">
									<div class="col-md-122">
										<div id="news-div" style="display: none; padding-right: 20px;">
											<h4><input type="checkbox" name="stadiums" value="1" <?php if ($group["stadiums"] == 1) echo "checked"; ?> />الملاعب</h4>
											<h4><input type="checkbox" name="images_albums" value="1" <?php if ($group["images_albums"] == 1) echo "checked"; ?> />الصور</h4>
											<h4><input type="checkbox" name="videos" value="1" <?php if ($group["videos"] == 1) echo "checked"; ?> />الفيديوهات</h4>
											<h4><input type="checkbox" name="users_groups" value="1" <?php if ($group["users_groups"] == 1) echo "checked"; ?> />المستخدمين</h4>
										</div>
									</div>
								</div>
							</div>
