...
<body>
	<div class="widget-area">
		...
		<div class="col-md-122" id="uploaded-images" style="margin-top: 50px; margin-right: 46px;">
		</div>
	</div>
					...
					$.ajax({
						...
						success: function(response) {
							if (response != 0)
							{
								...
								{
									newImages +=
									"<div class='uploaded-img' style='float: right; margin-left: 25px; margin-bottom: 30px;'>" +
